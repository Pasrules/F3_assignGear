...
// Radio operator
if (_typeOfUnit in ["rop","jtac","jp"]) then {
    _unit addBackpack _radio1;
};

// Squadleads && Weapons team leads (assistants)
if (_typeOfUnit in ["co", "dc", "rop", "jtac", "sm", "mmgag", "stmgag", "matag", "hatag", "statag", "mtrag", "mtrg", "msamag", "stsamag", "sp", "sn", "vc", "pp", "jp", "uav"]) then {
    _unit linkItem _radio2;
};

// Teamleads && Crewmembers
if (_typeOfUnit in ["ftl","dm","cm","pm","gren","vg","vd","pcc","pc","eng","engm","div"]) then {
